            ...
            <div  class="mt-5 card row-hover pos-relative py-3 px-3 mb-3 border-warning border-top-0 border-right-0 border-bottom-0 rounded-0">
              <div class="row align-items-center">
                <div class="col-md-8 mb-3 mb-sm-0">
                  ...
                  <p class="text-sm"><span class="op-6">Posted</span> <a class="text-black" href="#"><?php echo $post->created_at; ?></span> <a class="text-black" href="#">by <?php echo $post->post_author; ?></a></p>
